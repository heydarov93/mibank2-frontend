...
describe('ResendCodeTimer Component', () => {
  const endTime = Date.now() + 10000;

  it('should render the initial time correctly', () => {
    render(<ResendCodeTimer time={10000} endTime={endTime} runTimer={jest.fn()} />);
  ...
  it('should stop the timer when time reaches zero if setTime prop wasnt passed', () => {
    ...
    render(
      <ResendCodeTimer time={1000} endTime={Date.now() + 1000} runTimer={runTimer} />,
    );
  ...
  it('should show resend code label when hasResendBtn is true', () => {
    ...
    render(
      <ResendCodeTimer time={10000} endTime={endTime} runTimer={runTimer} hasResendBtn />,
    );
