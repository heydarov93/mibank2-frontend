...
import { ReactComponent as CircledCheckIcon } from 'assets/icons/CircledCheckIcon.svg';

export type SmallIssuanceCardProps = {
  name: string;
  fee: string;
  background: string;
  sx?: SxProps<Theme>;
    ...
    >
      ...
      >
        <Stack direction="row" alignItems="center" width="100%" gap="4px">
          {selected && <CircledCheckIcon style={{ flexShrink: 0 }} />}
          <Typography
            fontWeight={500}
            lineHeight={1.18}
            textAlign="right"
