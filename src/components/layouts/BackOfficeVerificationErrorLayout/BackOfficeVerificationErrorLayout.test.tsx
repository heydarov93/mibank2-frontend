...
import { BackOfficeVerificationErrorLayout } from './BackOfficeVerificationErrorLayout';
  ...
  return render(
    <BrowserRouter>
      <ThemeProvider theme={theme}>
        <BackOfficeVerificationErrorLayout />
      </ThemeProvider>
    </BrowserRouter>,
  );
};

describe('BackOfficeVerificationErrorLayout', () => {
