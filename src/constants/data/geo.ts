import { TVoivodeship } from 'types/types';
...
interface IPolandCity {
  city: string;
  voivodeship: TVoivodeship;
}

export const POLISH_CITIES: readonly IPolandCity[] = [
  {
    city: 'Będzin',
...
export const countries: readonly ICountry[] = [
  ...
  {
    code: 'CG',
    label: 'Congo, Republic of the Congo',
    phone: '242',
  },
  {
    code: 'CK',
  ...
  {
    code: 'IR',
    label: 'Iran, Islamic Republic of Iran',
    phone: '98',
  },
  {
    code: 'IQ',
